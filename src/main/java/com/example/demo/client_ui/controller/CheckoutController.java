...
public class CheckoutController {
    ...
    public String getCheckoutPage(@RequestParam(name = "method", required = false) String method,
        ...
        if (!type.isEmpty()) {
            ...
            if (this.currentAccount.getLanguageConfig().equals("vi") || HomeController.languageConfig.equals("vi")) {
                return "vi/checkout-vi" + type;
            }
        ...
        if (method == null) {
            ...
            if (this.currentAccount.getLanguageConfig().equals("vi") || HomeController.languageConfig.equals("vi")) {
                return "vi/checkout-vi";
            }
            return "checkout";
        }
        checkoutDTO.setPaymentMethod(method);
        if (this.currentAccount.getLanguageConfig().equals("vi") || HomeController.languageConfig.equals("vi")) {
            return "vi/checkout-vi" + method;
        }
