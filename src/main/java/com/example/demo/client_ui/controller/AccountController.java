...
public class AccountController {
    ...
    public ModelAndView getLoginPage(ModelMap model) {
        ...
        if (HomeController.languageConfig.equals("vi")) {
            return new ModelAndView("vi/login-vi", model);
        }
    ...
    public ModelAndView getSignInPage(ModelMap model) {
        ...
        if (HomeController.languageConfig.equals("vi")) {
            return new ModelAndView("vi/signup-vi", model);
        }
    ...
    public ModelAndView getAddressPage(ModelMap model) {
        ...
        if (this.currentAccount.getLanguageConfig().equals("vi")) {
            return new ModelAndView("vi/address-vi", model);
        }
    ...
    public ModelAndView getProfilePage(ModelMap model) {
        ...
        if (this.currentAccount.getLanguageConfig().equals("vi")) {
            return new ModelAndView("vi/profile-vi", model);
        }
        return mv;
    }
    ...
    public ModelAndView getOrderPage(ModelMap model) {
        ...
        if (this.currentAccount.getLanguageConfig().equals("vi")) {
            return new ModelAndView("vi/order-vi", model);
        }
    ...
    public ModelAndView getOrderDetailPage(@PathVariable Integer id, ModelMap model) {
        ...
        if (this.currentAccount.getLanguageConfig().equals("vi")) {
            return new ModelAndView("vi/order-detail-vi", model);
        }
